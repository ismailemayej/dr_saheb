...
import FacebookPageEmbed from "../FacebookPlugin";
  ...
  return (
    <div className="w-full py-8 bg-white dark:bg-gray-900">
      ...
      <div className="text-xs flex flex-col md:flex-row gap-8 mx-auto">
        ...
        <FacebookPageEmbed />
        {/* Right Section */}
        <div className="text-xs shadow-2xl md:w-1/2 space-y-4 bg-gray-50 dark:bg-gray-800 rounded-lg p-4 bangla">
          <Heading
            level={3}
            bold
            className="font-bold mb-6 text-gray-900 dark:text-gray-100"
          ...
          <ul className="list-decimal list-inside space-y-0.5 text-base text-gray-900 dark:text-gray-100">
          ...
          <p className="italic text-black dark:text-gray-100 font-bold">
